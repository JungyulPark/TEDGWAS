...
**Objective:** Graves disease (GD) is an autoimmune cause of hyperthyroidism; thyroid eye disease (TED) is an associated inflammatory orbital disorder. We compared genetic evidence linking blood *TSHR* and *IGF1R* expression to disease susceptibility. **Methods:** We used Wald-ratio or inverse-variance-weighted Mendelian randomization and colocalization (testing for shared expression–disease variants). Outcomes were Biobank Japan (BBJ) GD, UK Biobank (UKB) hyperthyroidism and FinnGen Graves ophthalmopathy. In-house orbital RNA sequencing (four TED patients, one control) was analyzed descriptively using transcript levels and fold changes without significance testing. **Results:** Of 2,544 eligible genes, 13 met the BBJ Bonferroni threshold (*P* < 0.05/2,544). Higher genetically predicted *TSHR* expression was associated with lower GD odds in BBJ (odds ratio [OR] per approximately one standard deviation 0.12, 95% confidence interval [CI] 0.07–0.21; *P* = 1.09×10⁻¹⁴), with concordant directions in UKB and FinnGen. Colocalization support exceeded the 0.80 probability threshold in BBJ and FinnGen, but not UKB. BBJ support fell below threshold when the shared-variant prior probability decreased from 10⁻⁵ to 10⁻⁶. Higher *IGF1R* expression was associated with higher odds in BBJ (OR 1.56, 95% CI 1.07–2.28; *P* = 0.0212) and UKB (*P* = 0.0117), but neither association met the discovery threshold. FinnGen findings were inconclusive (*P* = 0.182). *IGF1R* lacked strong colocalization support. No additional candidate met the combined BBJ–FinnGen colocalization criterion. Cohort-specific allele frequencies preserved these findings. **Conclusions:** Genetically predicted blood expression showed stronger evidence of association with GD susceptibility for *TSHR* than *IGF1R*. These findings neither establish a TED-specific effect within GD nor predict treatment response.

...
**Objective:** Graves disease (GD) causes autoimmune hyperthyroidism; thyroid eye disease (TED) is an associated inflammatory orbital disorder. We compared genetic evidence linking blood *TSHR* and *IGF1R* expression to disease susceptibility. **Methods:** We used Wald-ratio or inverse-variance-weighted Mendelian randomization and colocalization (testing for shared expression–disease variants). Outcomes were Biobank Japan (BBJ) GD, UK Biobank (UKB) hyperthyroidism and FinnGen Graves ophthalmopathy. In-house orbital RNA sequencing (four TED patients, one control) was analyzed descriptively. **Results:** Of 2,544 eligible genes, 13 met the BBJ Bonferroni threshold (*P* < 0.05/2,544). Higher genetically predicted *TSHR* expression was associated with lower BBJ GD odds (odds ratio [OR] per approximately one standard deviation 0.12, 95% confidence interval [CI] 0.07–0.21; *P* = 1.09×10⁻¹⁴), with concordant directions for the other outcomes. Colocalization probability exceeded 0.80 in BBJ and FinnGen, but not UKB. BBJ support fell below threshold when the shared-variant prior decreased from 10⁻⁵ to 10⁻⁶. Higher *IGF1R* expression was associated with higher odds of BBJ GD (OR 1.56, 95% CI 1.07–2.28; *P* = 0.0212) and UKB hyperthyroidism (*P* = 0.0117). *IGF1R* did not meet the BBJ discovery threshold. The FinnGen association was non-significant (*P* = 0.182). *IGF1R* lacked strong colocalization support; no additional candidate met the combined BBJ–FinnGen criterion. Cohort-frequency sensitivity preserved these findings. Mean orbital *TSHR* and *IGF1R* transcript levels were higher in TED than in the control. **Conclusions:** Evidence linking genetically predicted blood *TSHR* expression to GD susceptibility was stronger than for *IGF1R*. FinnGen population controls prevent isolating TED susceptibility within GD; treatment response was not assessed.

...
The contrast between *TSHR* and *IGF1R* illustrates a broader principle: genetic susceptibility loci and pharmacologic targets are overlapping but not identical categories. A locus may anchor inherited disease liability through expression-colocalized genetic regulation, as *TSHR* does here, without necessarily being the most immediately tractable therapeutic target. Conversely, a gene may be clinically relevant as a drug target, as IGF-1R is in the context of teprotumumab, without showing the germline expression-colocalized architecture expected of a primary susceptibility locus. Recognizing this distinction has practical value for therapeutic interpretation, because genetic prioritization identifies where inherited liability is concentrated, whereas pharmacologic intervention may act at downstream or parallel effector pathways. This complementarity is consistent with the broader observation that human genetic support for a target increases the likelihood of success in drug development, even though not every effective therapeutic target is a primary genetic susceptibility locus [27]. Our findings therefore support *TSHR* as an upstream susceptibility anchor and *IGF1R* as an effector axis, but they do not test whether targeting an upstream susceptibility anchor would provide clinical advantages over established effector-directed therapy. That question remains outside the scope of the present genetic prioritization study.
...
| 5×10⁻⁶ | 0.001 | EAS | 3 | Yes |
  ...
  *At the primary instrument-selection threshold (P < 5×10⁻⁸, r² < 0.001), the European reference yields a single independent instrument (rs179252); additional "independent" SNPs appear only at progressively relaxed r² thresholds and reflect the wider LD structure of the locus. SuSiE fine-mapping (susieR; 1000 Genomes EUR and EAS panels) placed all credible-set lead variants in substantial LD with rs179252 (minimum r² = 0.808 in EAS, 0.965 in EUR), supporting treatment of TSHR as a single-instrument, locus-level anchor. [Per-credible-set PIP values from the SuSiE output to be tabulated in the final supplementary file.]*
...
| Gene | Chr | BBJ discovery *P* | Coloc PP.H4 (BBJ) | Coloc PP.H4 (FinnGen) | Top SNP |
|---|---|---|---|---|---|
| *HSD3B7* | 16 | 2.0×10⁻⁷ | 0.616 | 0.026 | rs4889606 |
| *VKORC1* | 16 | 6.4×10⁻⁷ | 0.360 | 0.029 | rs34649473 |
| *PRSS36* | 16 | 2.0×10⁻⁶ | 0.157 | 0.038 | rs78924645 |

  *All three genes lie within a ~143-kb window and none reaches strong colocalization (PP.H4 ≥ 0.80) in either outcome; their co-significance reflects shared regional LD rather than three independent causal effects. [Exact base-pair coordinates and pairwise LD (r²) among the three lead SNPs to be tabulated in the final supplementary file.]*
...
| 12 | Descriptive data (instrument counts, F-statistics) | Results; Table S4 |
| 13 | Main MR estimates with CIs | Results; Tables 2, 3; Figures 2, 3 |
| 14 | Sensitivity / robustness results | Results; Table S6 |

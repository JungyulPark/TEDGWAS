...
**Conclusion:** This framework supports *TSHR* as an expression-colocalized susceptibility anchor for GD, whereas *IGF1R* showed nominal genetic association without expression colocalization—a genetic profile more compatible with an effector-target interpretation than with the *TSHR*-like expression-colocalized susceptibility architecture.

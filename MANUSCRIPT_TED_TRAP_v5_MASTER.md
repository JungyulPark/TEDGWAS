...
Thus, *IGF1R* showed nominal positive-direction MR evidence without reaching the eQTL–GWAS colocalization threshold (PP.H4 ≥ 0.80). This profile differs from the colocalized *TSHR* signal in the two Graves disease phenotypes. The interpretation of this profile—in particular its relationship to the established therapeutic role of IGF-1R blockade—is considered in the Discussion.

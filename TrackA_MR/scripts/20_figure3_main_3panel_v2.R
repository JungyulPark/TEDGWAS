...
panelC <- ggplot(ivw_plot, aes(x = beta, y = Outcome, color = Category)) +
    ...
    labs(
        ...
        subtitle = "Germline IGF1R perturbation does not cause metabolic phenotypes (null IVW); Height confirms instrument validity.",
...
ggsave("TrackA_MR/figures/Figure3_main_3panel_v2.pdf", combined,
    width = 11, height = 8, device = cairo_pdf, bg = "white"
) # PATCH: height 9→8
ggsave("TrackA_MR/figures/Figure3_main_3panel_v2.png", combined,
    width = 11, height = 8, dpi = 600, bg = "white"
)
ggsave("TrackA_MR/figures/Figure3_main_3panel_v2.tiff", combined,
    width = 11, height = 8, dpi = 600, compression = "lzw", bg = "white"
)

cat("\n✅ Figure 3 Main v2 saved (text overlap + star removed, tighter layout)\n")

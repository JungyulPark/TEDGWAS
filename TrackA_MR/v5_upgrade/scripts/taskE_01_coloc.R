...
OUT      <- file.path(WORK_DIR, "05_coloc_candidates/TaskE_01_coloc_results_v1.csv")
...
GENES <- list(
  ...
  HSD3B7 = list(chr=16L, start=30992922L, end=30997065L),  # optional
  PRSS36 = list(chr=16L, start=31142978L, end=31149401L),  # optional
  VKORC1 = list(chr=16L, start=31102175L, end=31106118L)   # optional
)
PRIORITY_GENES <- c("TSHR","IGF1R","CTLA4")  # run these first; others optional

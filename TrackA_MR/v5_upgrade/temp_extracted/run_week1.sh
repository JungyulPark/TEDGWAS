...
REQUIRED_INPUTS=(
  "c:/ProjectTEDGWAS/2019-12-11-cis-eQTLsFDR-ProbeLevel-CohortInfoRemoved-BonferroniAdded.txt.gz"
)
...
REQUIRED_TOOLS=(
  "c:/ProjectTEDGWAS/tools/gcta-1.94.1-win/gcta64.exe"
...
echo "============================================"
Rscript "${SCRIPTS}/taskA_01_pqtl_check.R"
...
echo "============================================"
Rscript "${SCRIPTS}/taskB_01_locus_extract.R"

echo ""
echo "============================================"
echo "Task B.2: LD clumping sensitivity"
echo "============================================"
Rscript "${SCRIPTS}/taskB_02_ld_clumping.R"
...
echo "============================================"
Rscript "${SCRIPTS}/taskB_04_susie_finemap.R"

echo ""
echo "============================================"
echo "Task B.5: Integration of COJO + SuSiE"
echo "============================================"
Rscript "${SCRIPTS}/taskB_05_integration.R"

...
EQTLGEN_FILE <- "c:/ProjectTEDGWAS/2019-12-11-cis-eQTLsFDR-ProbeLevel-CohortInfoRemoved-BonferroniAdded.txt.gz"
...
#
# This file is ~6 GB compressed. Read with fread and filter on the fly.

cat("\nReading eQTLGen full sumstats from:\n  ", EQTLGEN_FILE, "\n")
cat("(this may take 5-10 minutes for full file)\n")

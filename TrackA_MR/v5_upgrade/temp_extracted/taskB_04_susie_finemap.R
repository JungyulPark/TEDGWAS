...
BFILE_EUR <- "c:/ProjectTEDGWAS/v5_upgrade/data/1000G_EUR_phase3/EUR_chr14"
BFILE_EAS <- "c:/ProjectTEDGWAS/v5_upgrade/data/1000G_EAS_phase3/EAS_chr14"
...
# -----------------------------------------------------------------------------
# Use the LD matrix already computed for each ancestry; look up the row for rs179252
# (omitted for brevity — Gemini to implement using the same compute_ld_matrix helper)

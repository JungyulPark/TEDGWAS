# ============================================================
# Figure 3 v6.4 — Three-panel vertical stack (TED-TRAP v4.5)
# v6.4 changes (FROM v6.3) — 근본적 layout fix:
#  1. Canvas: 9 → 12 inch width (subtitle 잘림 방지)
#  2. plot.title.position = "plot" (title/subtitle를 panel 기준이 아닌 plot 기준 정렬)
#  3. plot.caption.position = "plot" (모든 text 일관 정렬)
#  4. 모든 subtitle 짧게 줄임
#  5. axis.text margin 단축 → axis title이 chart와 더 가깝게
# ============================================================
...
cat("Figure 3 v6.4 saved.\n")
cat("✅ Canvas: 12 x 15 in (was 9 x 15) — wider for subtitle\n")
cat("✅ plot.title.position = 'plot' for ALL panels (left-most alignment)\n")
cat("✅ All subtitles SHORTENED to fit one line\n")
cat("✅ axis.text margin reduced (axis title closer to chart)\n")
cat("Dimensions: 12 x 15 in @ 450 DPI = 5400 x 6750 px = 36.5 MP\n")

# ============================================================
# Figure 3 v7.2 — Three-panel vertical stack (TED-TRAP v4.5)
# v7.2 변경 (FROM v7.1):
#  - a/b/c/d inset label을 검정색으로 (was: gray30)
#  - 위치를 더 왼쪽 위로 이동 (x=-0.20, y='d')
#  - 결과: 더 가독성 있고 표준적인 inset legend
# ============================================================
...
p_c <- ggplot(panel_c_data, aes(x = beta, y = outcome, color = category)) +
  ...
  # ★ v7.2: 검정색 + 왼쪽 위로 이동 (x=-0.20, y='d')
  annotate("label", x = -0.20, y = "d",
...
cat("Figure 3 v7.2 saved.\n")
cat("핵심 변경 (FROM v7.1):\n")
cat("  ✅ a/b/c/d label을 검정색으로 (가독성 ↑)\n")
cat("  ✅ Annotation 위치를 더 왼쪽 위로 (x=-0.20, y='d')\n")

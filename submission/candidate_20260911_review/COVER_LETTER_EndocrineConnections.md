...
Thirteen genes met the discovery threshold. TSHR showed associations in all outcomes and strong shared expression–disease signals in BBJ and FinnGen. IGF1R showed nominal associations in BBJ and UKB, but its shared-variant evidence remained unresolved. No additional candidate met the combined BBJ and FinnGen criterion. Cohort-frequency sensitivity analyses preserved the discovery-hit set and colocalization classifications while changing some estimates and detection thresholds.

The manuscript presents odds ratios, confidence intervals and *P* values, with supporting analyses in four supplementary tables. FinnGen uses population controls and cannot isolate eye-disease susceptibility within Graves disease. Blood expression, limited instrument counts and the colocalization model constrain inference. Orbital observations from four TED samples and one control are descriptive only. The findings do not establish treatment direction or challenge the clinical evidence for IGF-1R blockade.

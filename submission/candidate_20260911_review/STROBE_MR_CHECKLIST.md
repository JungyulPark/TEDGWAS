...
| 8 | Additional analyses | Methods; Tables S1–S5. eQTLGen frequency substitution and re-harmonization were performed. |
...
| 13a–e | Additional results | Tables S1–S5; Figure S1. Post hoc leave-one-out results are reported in Results, Table S5, Figure S2 and Supplementary Data 6 (15 omissions; five all-SNP comparators). Single-SNP starting sets were ineligible. Steiger and bidirectional MR were not applied; Figure S1 is descriptive. |

...
The executed frequency-sensitivity scripts are preserved in analysis_scripts. Their historical workspace layout and locally authorized raw inputs are described in candidate_20260905_maf/reproducibility/README.md at the analytical baseline commit recorded in provenance/clinical_revision.json. No statistical rerun was performed merely to simplify presentation on 11 September. Consolidated files preserve primary and cohort-frequency results, and the original verification reports and input hashes remain in provenance/maf.
